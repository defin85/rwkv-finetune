...
- Outputs:
  - merged 1C core corpus в формате `Instruction/Response + <|endoftext|>`;
...
2. Добавить source adapters и merged-stage quality gates.
3. Подключить merged core корпус к профилю `1C-Expert-v4`.
