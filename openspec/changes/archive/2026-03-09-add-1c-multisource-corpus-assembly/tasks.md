...
- [x] 6.1 Блок 1 MUST быть завершён до блоков 2-4.
- [x] 6.2 Блок 2 MUST быть завершён до блока 3.
- [x] 6.3 Блок 3 MUST быть завершён до финальной верификации блока 5.
